...
exports.config = {
    ...
    capabilities: [
        {
            ...
            platformName: 'Android',
            app: './app/android/app-debug.apk',          // Path to your native app
            appPackage: '',  // Package name of your app
            appActivity: '', // App activity of the app
    ...
    onComplete: function (exitCode, config, capabilities, results) {
        ...
        generate({
            ...
            //pageFooter: '<div class="created-by"> <p>' + process.env.PROJECT_NAME + ' - Exemplo Tecnologia</p> <a href="http://exemplo.net/" target="_blank"><i class="fa fa-rss-square fa-2x"></i></a> <a href="https://github.com/exemplotecnologia/' + process.env.REPORT_NAME + '" target="_blank"><i class="fa fa-github-square fa-2x"></i></a> <a href="https://www.linkedin.com/company/exemplo-tecnologia/" target="_blank"><i class="fa fa-linkedin-square fa-2x"></i></a> <a href="https://www.youtube.com/channel/UC7EA42ScnmkiWW8ZSOG58rA" target="_blank"><i class="fa fa-youtube-play fa-2x"></i></a> </div>',
